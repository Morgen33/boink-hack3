...
const questions: Question[] = [
  {
    ...
    choices: [
      { id: "a", text: "🔥 'This is fine' dog meme", personality: "stoic", points: 3 },
      { id: "b", text: "💎 'Diamond hands' - buying the dip", personality: "degen", points: 4 },
      { id: "c", text: "😱 Wojak crying face", personality: "emotional", points: 2 },
      { id: "d", text: "🤡 'Honk honk' clown world", personality: "chaos", points: 5 }
    ]
  },
  {
    id: 2,
    ...
    choices: [
      { id: "a", text: "📈 'Number go up' chart", personality: "optimist", points: 3 },
      { id: "b", text: "🚨 'This is not financial advice' disclaimer", personality: "careful", points: 2 },
      { id: "c", text: "🚀 'To the moon' rocket", personality: "degen", points: 4 },
      { id: "d", text: "🤷 'I don't know shit about fuck'", personality: "honest", points: 3 }
    ]
  },
  {
    id: 3,
    ...
    choices: [
      { id: "a", text: "🎰 YOLO life savings immediately", personality: "degen", points: 5 },
      { id: "b", text: "🧐 Research for 6 hours first", personality: "careful", points: 2 },
      { id: "c", text: "📊 Put in $100 for the memes", personality: "balanced", points: 3 },
      { id: "d", text: "💀 'Another day, another rug'", personality: "cynical", points: 4 }
    ]
  },
  {
    id: 4,
    ...
    choices: [
      { id: "a", text: "🔥 'Money printer go brrr'", personality: "degen", points: 4 },
      { id: "b", text: "⏰ 'I'll wait for 3am'", personality: "patient", points: 2 },
      { id: "c", text: "🤬 Angry Pepe screaming", personality: "emotional", points: 3 },
      { id: "d", text: "🎭 'Welcome to Ethereum'", personality: "accepting", points: 3 }
    ]
  },
  {
    id: 5,
    ...
    choices: [
      { id: "a", text: "🙏 'Respect the diamond hands'", personality: "respectful", points: 3 },
      { id: "b", text: "🧓 'OK boomer' Bitcoin grandpa", personality: "chaos", points: 4 },
      { id: "c", text: "💎 'This is the way'", personality: "community", points: 3 },
      { id: "d", text: "📈 'You're rich now, right?'", personality: "curious", points: 2 }
    ]
  },
  {
    id: 6,
    ...
    choices: [
      { id: "a", text: "🖼️ 'Right-click save as'", personality: "chaos", points: 4 },
      { id: "b", text: "🎨 'Actually, some are artistic'", personality: "optimist", points: 3 },
      { id: "c", text: "💸 'Expensive JPEGs'", personality: "cynical", points: 4 },
      { id: "d", text: "🤷 'Each to their own'", personality: "neutral", points: 2 }
    ]
  },
  {
    id: 7,
    ...
    choices: [
      { id: "a", text: "🌾 'Farming every yield'", personality: "degen", points: 5 },
      { id: "b", text: "🏦 'Banks hate this one trick'", personality: "rebel", points: 4 },
      { id: "c", text: "⚠️ 'Smart contracts are risky'", personality: "careful", points: 2 },
      { id: "d", text: "📚 'What's DeFi?'", personality: "newbie", points: 1 }
    ]
  },
  {
    id: 8,
    ...
    choices: [
      { id: "a", text: "🚀 Immediately buy more DOGE", personality: "degen", points: 5 },
      { id: "b", text: "🙄 'Here we go again'", personality: "tired", points: 3 },
      { id: "c", text: "📱 Screenshot and meme it", personality: "content", points: 4 },
      { id: "d", text: "😴 'I was sleeping like normal'", personality: "healthy", points: 2 }
    ]
  }
];
          ...
          <div className="space-y-3">
            {question.choices.map((choice) => (
              <Button
                key={choice.id}
                variant="outline"
                className="w-full h-auto p-4 text-left justify-start hover:bg-purple-900/20 hover:border-purple-500"
